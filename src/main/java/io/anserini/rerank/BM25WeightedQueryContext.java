...
public class BM25WeightedQueryContext<K>  extends  RerankerContext{
    ...
    public BM25WeightedQueryContext(IndexSearcher searcher, K queryId, Query query, String queryDocId, String queryText,
     ...
     */
    public List<TermScoreDetails> preprocess(List<TermScoreDetails> termScoreDetails, BM25WeightedQueryContext context_) {
    ...
    public void setSynonyms(String actualTerm, TermScoreDetails actualTermDetails,List<TermScoreDetails> termScoreDetails) {
        for (TermScoreDetails term : termScoreDetails) {
            ...
            Map<String, List<WeightedExpansionTerm>> stringListMap = BM25WeightedQueryContext.getQueryExpansionTerms(queryId.toString());
